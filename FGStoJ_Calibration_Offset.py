...
def fgs_to_jframe(xFGS_meas, yFGS_meas, RA, DEC, PA, qEST, SCVel):
    ...
    #
    # NOTE: Matlab uses pinv for solving the matrix equation. However, the
    #       python version (pinv or pinv2) diverges upon solving the equation
    #       when there are more than 2 sources involved. I looked for using
    #       other methods and settled on the least-square solver
    #       (scipy.sparse.linalg.lsqr) as long as the default conditions
    #       are used.
    #
    if mm == 1:
